<template>
    ...
    <Title class="donate-title" msg="Queremos que todos tenham a capacidade de checar e mediar informações, e você pode fazer a diferença." />
    ...
    >
        <div>
            <h3 style="font-size: 23px; text-align: center; color: white; font-weight: 200; letter-spacing: 1px; margin: 0;">
